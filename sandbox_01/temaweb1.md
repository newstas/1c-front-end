...
[Dig – это веб-аналог UNIX-команды dig][ref_002] - Набора [инструментов администратора Google][ref_003]
...
Проверка MX – это удобный инструмент для проверки конфигурации DNS-серверов. Он помогает обнаруживать типичные ошибки настройки записей MX.
