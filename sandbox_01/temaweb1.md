...
(ключ **«-»**) в этом случае письмо не проходит дополнительных проверок и сразу отвергается.

&emsp;Помимо «~» и «-», для параметра «all» существуют ещё ключи:

&emsp;- ключ **«+»** — принимать почту,
&emsp;- ключ **«?»** — воспринимать письмо нейтрально.
