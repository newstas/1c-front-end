...
## Flexible Box, Flex Layout (Гибкий макет)
...
## Главная ось (Main Axis) — свойство `flex-direction`
...
значение атрибута dir у контейнера. Входит в свойство-сокращение `flex-flow`.
