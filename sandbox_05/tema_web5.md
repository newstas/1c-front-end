# WEB-I ТЕМА 5 — JavaScript. Условные конструкции и циклы

На этом занятии мы изучим:

- Функции
  - присваивать функции переменным
  - передавать функцию в качестве аргумента другим функциям
...
Оператор (инструкция) `if` может содержать необязательный блок `else` (**иначе**). 
...
Примитивное значение. Автоматически присваивается **переменным, которые были только объявлены** или **аргументам, 
для которых не были установлены значения**.
