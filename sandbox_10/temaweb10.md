...
- 3.2.1 Поворот - значение `rotate` *пример:* `transform: rotate(45deg);`
- 3.2.2 Масштабирование - значение `scale` *пример:* `transform: scaleX(1.5) scaleY(0.5);
- 3.2.3 Перекос - значение `skew` *пример:* `transform: skew(30deg, 0deg);`

*пример:* `transform: translate(40px, -20px);`
(*перемещение на 40 пикселей вправо и на 20 вверх*)

- 3.2.4 Перемещение - `translate`

Значение `translate` *пример:* `transform: translate(40px, -20px);`
(*перемещение на 40 пикселей вправо и на 20 вверх*)
